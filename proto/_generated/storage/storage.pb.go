...
type UpdateCloudApproveRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *UpdateCloudApproveRequest) Reset() {
	*x = UpdateCloudApproveRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *UpdateCloudApproveRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateCloudApproveRequest) ProtoMessage() {}

func (x *UpdateCloudApproveRequest) ProtoReflect() protoreflect.Message {
	mi := &file_storage_storage_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateCloudApproveRequest.ProtoReflect.Descriptor instead.
func (*UpdateCloudApproveRequest) Descriptor() ([]byte, []int) {
	return file_storage_storage_proto_rawDescGZIP(), []int{1}
}

func (x *UpdateCloudApproveRequest) GetUrl() []string {
	if x != nil {
		return x.Url
	}
	return nil
...
var file_storage_storage_proto_rawDesc = []byte{
	...
	0x64, 0x41, 0x74, 0x22, 0x2d, 0x0a, 0x19, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x43, 0x6c, 0x6f,
	...
	,
...
var file_storage_storage_proto_goTypes = []interface{}{
	...
	(*UpdateCloudApproveRequest)(nil), // 1: storage.UpdateCloudApproveRequest
...
var file_storage_storage_proto_depIdxs = []int32{
	...
	1, // 2: storage.StorageServices.UpdateCloudApprove:input_type -> storage.UpdateCloudApproveRequest
	3, // 3: storage.StorageServices.UpdateCloudApprove:output_type -> google.protobuf.Empty
...
func file_storage_storage_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_storage_storage_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*UpdateCloudApproveRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
