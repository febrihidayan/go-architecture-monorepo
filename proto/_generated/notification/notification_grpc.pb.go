...
func (c *notificationServicesClient) CreateDeviceToken(ctx context.Context, in *CreateDeviceTokenRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, NotificationServices_CreateDeviceToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServicesClient) SendNotification(ctx context.Context, in *SendNotificationRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, NotificationServices_SendNotification_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedNotificationServicesServer should be embedded to have
...
func (UnimplementedNotificationServicesServer) testEmbeddedByValue() {}
...
func RegisterNotificationServicesServer(s grpc.ServiceRegistrar, srv NotificationServicesServer) {
	// If the following call pancis, it indicates UnimplementedNotificationServicesServer was
