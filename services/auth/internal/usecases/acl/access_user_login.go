...
func (x *aclInteractor) AccessUserLogin(ctx context.Context, userId string) (*entities.AclMeta, *exceptions.CustomError) {
	...
	permissions, err := x.permissionRepo.AllPermissionByUserId(ctx, user.UserId)
	if err != nil {
