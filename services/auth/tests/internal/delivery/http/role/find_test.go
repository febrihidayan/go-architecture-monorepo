...
func (x *RoleHandlerSuite) TestFind() {
	...
	testCases := []struct {
	...
	}{
		{
			...
			mock: func(m HandlerParams) {
				x.RoleUsecase.On("Find", mock.Anything, mock.Anything).Return(&entities.Role{}, nil)
			},
		},
		{
			...
			mock: func(m HandlerParams) {
				x.RoleUsecase.On("Find", mock.Anything, mock.Anything).Return(nil, x.Error)
			},
		},
	}
